...
impl LayoutStyle {
    ...
    pub(crate) fn new_default() -> LayoutStyle {
        LayoutStyle {
            ...
            top: DimensionProto::new_undefined().into(),
            left: DimensionProto::new_undefined().into(),
            bottom: DimensionProto::new_undefined().into(),
            right: DimensionProto::new_undefined().into(),
            width: DimensionProto::new_undefined().into(),
            height: DimensionProto::new_undefined().into(),
            min_width: DimensionProto::new_undefined().into(),
            max_width: DimensionProto::new_undefined().into(),
            min_height: DimensionProto::new_undefined().into(),
            max_height: DimensionProto::new_undefined().into(),
            bounding_box: Some(Size::default()).into(),
            flex_grow: 0.0,
            flex_shrink: 0.0,
            flex_basis: DimensionProto::new_undefined().into(),
