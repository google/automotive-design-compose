...
pub fn encode_dcd_with_header (    header: &DesignComposeDefinitionHeader,
                                   doc: &DesignComposeDefinition,) -> Vec<u8>
{
...
pub fn decode_dcd_with_header<B>(mut msg: B) -> Result<(DesignComposeDefinitionHeader, DesignComposeDefinition), Error>
where B: Buf
{
