@FS-452 @REQ_FS-416
Feature: SMR-016 Allow OEMs to Designate Bus Signal to UI Relationships
	#The Vehicle Software UI toolkit shall provide a way for OEMs to designate which OEM specific Vehicle Bus signals govern the presence of associated OEM specific UI elements.
