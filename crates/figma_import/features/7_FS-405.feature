@FS-452 @REQ_FS-405
Feature: SMR-005 Verify Static UI Elements Not Onscreen
	#The Safety Monitor shall verify that OEM designated static UI elements are not visible onscreen when the the associated message bus signals are not active.
