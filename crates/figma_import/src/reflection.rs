...
pub fn registry() -> serde_reflection::Result<serde_reflection::Registry> {
    ...
    tracer
        .trace_type::<dc_bundle::legacy_definition::layout::grid::Display>(&samples)
    ...
    tracer
        .trace_type::<dc_bundle::legacy_definition::layout::grid::Overflow>(&samples)
    ...
    tracer
        .trace_type::<dc_bundle::legacy_definition::layout::grid::LayoutSizing>(&samples)
