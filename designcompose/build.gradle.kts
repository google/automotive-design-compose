...
tasks.register<JacocoReport>("jacocoDebugUnitTestReport") {
    ...
    classDirectories.setFrom(
        files(
            fileTree(layout.buildDirectory.dir("intermediates/javac/debugUnitTest")) { exclude(jacocoExcludes) },
            fileTree(layout.buildDirectory.dir("tmp/kotlin-classes/debugUnitTest")) { exclude(jacocoExcludes) },
        )
    )
