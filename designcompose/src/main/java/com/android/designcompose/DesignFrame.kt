...
internal fun DesignFrame(
    ...
    val subscribeLayout =
        @Composable { style: ViewStyle ->
            ...
            // a
            // component instance that changes to another variant. It can also change due to a live
            // update. Subscribing when already subscribed simply updates the view in the layout
            // system.
