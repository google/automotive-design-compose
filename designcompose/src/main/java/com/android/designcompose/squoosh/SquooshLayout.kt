...
/// Compute a final layout ID from a parent layout ID (16bits) and a unique node ID from the DCF
internal fun computeLayoutId(rootLayoutId: Int, uniqueViewId: Short): Int {
    return rootLayoutId + uniqueViewId
}
