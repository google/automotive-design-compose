        ...
        if (strArrayResId != Resources.ID_NULL) {
            ...
            if (textArray.size == styledTextData.styledTextsCount) {
                ...
                for (i in textArray.indices) {
                    output.add(
                        StyledTextRun.newBuilder()
                            .setText(textArray[i])
                            .setStyle(styledTextData.getStyledTexts(i).style)
                            .build()
                    )
                }
                return output
        ...
        if (styledTextData.styledTextsCount == 1) {
            ...
            if (strResId != Resources.ID_NULL) {
                ...
                return mutableListOf(
                    StyledTextRun.newBuilder()
                        .setText(context.getString(strResId))
                        .setStyle(styledTextData.getStyledTexts(0).style)
                        .build()
                )
            } else {
