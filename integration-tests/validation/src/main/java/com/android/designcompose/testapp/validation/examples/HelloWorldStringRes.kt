...
interface HelloWorldStringRes {
    @DesignComponent(node = "#MainFrame") fun Main(@Design(node = "#Name") @StringRes name: Int)
}

@Composable
fun HelloWorldStringRes() {
    HelloWorldStringResDoc.Main(
        name = R.string.name_world,
